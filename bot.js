...
if (tarih > 1296000000) kontrol = '<a:hydra:792002325370634270> __**Bu Kullanıcı Güvenli**__ <a:hydra:792002325370634270>'
  ...
  let kanal1 = client.channels.get(kanal);
   ...
   .setTitle(`<a:hydratac:789369824249643009> | \`✵ HYDRA'ya Bir Üye Katıldı!\` | <a:hydratac:789369824249643009>`)
    .setDescription(`
...
**<a:hydrata2:791857864255078420> __Aramıza Hoşgeldin! ${member}__ <a:hydrata2:791857864255078420>**
  ...
  <a:hydrayildizi3:791092780398673940> ** <@&${ayarlar.yetkiliROL}> __seninle ilgilenicektir.__ ** <a:hydrayildizi3:791092780398673940>

  <a:hydratac5:791858527966724125> ** __Hesabın Oluşturulma Tarihi:__** \n • \` ${moment(member.user.createdAt).format("YYYY DD MMMM dddd (hh:mm:ss)")} \`<a:hydratac5:791858527966724125>
